export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	oricorio: {
		...
		formeOrder: ["Oricorio", "Oricorio-Pom-Pom", "Oricorio-Pau", "Oricorio-Sensu"],
	},
	oricoriopompom: {
		num: 741,
	...
	ursaluna: {
		...
		prevo: "Ursaring",
		evoType: "other",
		evoCondition: "Peat Block when theres a full moon",
		eggGroups: ["Field"],
	...
	pawmot: {
		...
		prevo: "Pawmo",
		evoType: "other",
		evoCondition: "walk 1000 steps in Lets Go",
		eggGroups: ["Field"],
	},
	tandemaus: {
		num: 924,
