...
<span style="color:green">**Note:** The following is a cleaned version of the content pasted from PokemonShowdown (`PS`) page</span> [`ladderhelp.md`](`https://pokemonshowdown.com/pages/ladderhelp.md`)
